...
| [Public Architecture](#basic-architecture)  | Private architecture reference: [GPT-RAG](https://github.com/Azure/GPT-RAG) |  [Standard Zero-Trust Architecture](https://github.com/Azure/GPT-RAG) |
| --- | --- | --- | 
